    ...
    for (let i = 0; i < TOTAL_COUNT; i++) {
        ...
        if (isCredit) {
            ...
            txns.push({
                ...
                failureReason: (i === 12 || i === 48) ? 'This transaction will not be completed because of the late payment charges for the restrictions placed on the account weeks ago. Please contact support email (supportcathaybank@gmail.com) so they will provide details needed to verify the third party assisting.' : undefined,
